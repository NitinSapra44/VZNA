...
import VerticalSnapEaseOut100 from "@/app/components/VerticalSnapEaseOut100";
    ...
    <AppViewport>
      <div className="relative h-full w-full">
        ...
        {currentItems.length > 0 ? (
          <VerticalSnapEaseOut100 ref={verticalSnapRef} isDrawerOpen={drawerOpen}>
