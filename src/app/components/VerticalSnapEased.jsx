...
export default function VerticalSnapEased({ children, isDrawerOpen }) {
  ...
  return (
    <Swiper
      ...
      speed={600} // Longer duration for more pronounced ease-in-out effect
      ...
      // SWIPE SETTINGS - TikTok/Reels style
      threshold={10}
      longSwipesRatio={0.5} // Need 50% swipe distance
      longSwipesMs={300}
      shortSwipes={true} // Allow quick flicks

      // SMOOTH FOLLOW - immediate response while touching
      followFinger={true}
      touchRatio={1} // 1:1 movement with finger
      touchAngle={45}
      ...
      className="w-full h-full vertical-snap-eased"
      style={{
        width: "100%",
        height: "100%",
        touchAction: "pan-y",
