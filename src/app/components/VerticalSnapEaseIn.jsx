...
export default function VerticalSnapEaseIn({ children, isDrawerOpen }) {
  ...
  const handleSwiper = useCallback((swiper) => {
    ...
    swiper.on('touchEnd', () => {
      ...
      scrollTimeoutRef.current = setTimeout(() => {
        ...
        // Apply ease-in for the final snap (slow start, fast end)
        swiper.wrapperEl.style.transitionTimingFunction = 'ease-in';
      }, 10);
    });
  ...
  return (
    <Swiper
      ...
      className="w-full h-full vertical-snap-ease-in"
      style={{
        width: "100%",
        height: "100%",
        touchAction: "pan-y",
